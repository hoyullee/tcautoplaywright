...
async def test_case():
    async with async_playwright() as p:
        ...
        try:
            ...
            login_button = page.locator('a[href*="login"], button:has-text("로그인"), .login, [data-testid*="login"]').first
            ...
            assert 'login' in current_url, f"로그인 페이지가 아닙니다. 현재 URL: {current_url}"
